...
public class Translation2d implements ITranslation2d<Translation2d> {
    ...
    public static Translation2d fromPolar(com.team254.lib.geometry.Rotation2d direction, double magnitude){
     ...
     * @return
     */
    public Translation2d translateBy(double distance, com.team254.lib.geometry.Rotation2d angle) {
        double xDelta = Math.cos(Math.toRadians(angle.getDegrees())) * distance;
        double yDelta = Math.sin(Math.toRadians(angle.getDegrees())) * distance;
	...
	public double distanceToLine(Translation2d a, Translation2d b) {
		...
		Translation2d perpLine = line.rotateBy(new com.team254.lib.geometry.Rotation2d(90));
     ...
     * @return
     */
    public static com.team254.lib.geometry.Rotation2d updatedGetAngle(final Translation2d a, final Translation2d b) {
    ...
    public Translation2d rotateAroundOrigin(final com.team254.lib.geometry.Rotation2d rotation) {
        return rotateAround(new Translation2d(), rotation);
    }

    public Translation2d rotateAround(final Translation2d rotateAround, final com.team254.lib.geometry.Rotation2d rotation) {
    ...
    private static Translation2d rotateAround(final Translation2d point, final Translation2d rotateAround,
                                              final com.team254.lib.geometry.Rotation2d rotation) {
